                    ...
                    <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-dark-1 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                        ...
                        @csrf   
                            <div class="intro-x mt-8">
                                <input type="text" id="email" class="intro-x login__input form-control py-3 px-4 border-gray-300 block" 
                                ...
                                @enderror
                                <input type="password" id="password" class="intro-x login__input form-control py-3 px-4 border-gray-300 block mt-4" 
